---
id: Artifact.Knowledgebaseservicetest
type: Artifact
label: KnowledgeBaseServiceTest.spec.ts
attributes:
  cases: '14'
  describes: ''
  locator: 14 cases
  ...
  source: backend/src/test/java/com/wab2b/kb/KnowledgeBaseServiceTest.java
  support: S-tested
relationships:
- validates: Capability.Kb
---
