---
id: Artifact.Userserviceailimitstest
type: Artifact
label: UserServiceAiLimitsTest.spec.ts
attributes:
  cases: '9'
  describes: ''
  locator: 9 cases
  ...
  source: backend/src/test/java/com/wab2b/user/UserServiceAiLimitsTest.java
  support: S-tested
relationships:
- validates: Capability.User
---
